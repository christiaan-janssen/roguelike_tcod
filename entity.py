...
class Entity:
    ...
    def __init__(self, x, y, char, color, name, blocks=False, render_order=RenderOrder.CORPS,
    ...
    def move_towards(self, target_x: int, target_y: int, game_map, entities) -> None:
        """
        Move towards the location specified by target_x and target_y
        """
        dx = target_x - self.x
        dy = target_y - self.y
    ...
    def distance_to(self, other):
        """Calculate the distance between self and other entity"""
        dx = other.x - self.x
        dy = other.y - self.y
